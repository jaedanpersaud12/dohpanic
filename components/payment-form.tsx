...
export function PaymentForm({ currency, priceCents }: Props) {
  ...
  if (done) {
    return (
      <div className="t-pop-in flex flex-col items-center rounded-2xl border border-[var(--border)] bg-[var(--card)] p-10 text-center">
        <SuccessCheck />
        <h3 className="mt-6 text-2xl">Sent through</h3>
  ...
  return (
    ...
    >
      <h2 className="text-xl">Send your proof of payment</h2>
      ...
      <div className="mt-7 grid gap-5">
        ...
        <div>
          ...
          >
            <div>
              <div className="mt-3 flex items-center gap-2.5 rounded-xl border border-[var(--accent)]/30 bg-[var(--accent)]/10 px-4 py-3">
                <Ticket className="size-4 shrink-0 text-[var(--accent)]" />
                <p className="text-sm text-[var(--foreground)]">
                  That&apos;s{" "}
                  <span
                    key={ticketCount}
                    className="t-number-pop inline-block font-semibold text-[var(--accent)]"
                  >
                    {ticketCount}
                  </span>{" "}
            ...
            <button
              ...
              className={cn(
                ...
                dragging
                  ...
                  : "border-[var(--input)] hover:border-white/30 hover:bg-white/[0.03]"
              )}
            >
              <ImageUp className={cn("size-6 transition-colors", dragging ? "text-[var(--accent)]" : "text-[var(--muted-foreground)]")} />
        ...
        <div>
          ...
          <Textarea id="note" name="note" placeholder="e.g. 3 of these are for Sipho, Kea and Ama" />
        </div>
      </div>
